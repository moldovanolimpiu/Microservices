...
public class RecommendationService {
    ...
    public List<Movie> fetchRecommendedMovies(Movie movie, boolean chaos) throws SQLException, InterruptedException, ExecutionException {
        List<Movie> movies = new ArrayList<Movie>();
        String sql = "SELECT * FROM movies WHERE genre = ? AND name NOT LIKE ?";
